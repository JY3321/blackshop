                ...
                $.ajax({
      				...
      				if(json){
      					...
      					if(json.flag){
    						 ...
    						 $("#login_errorEmail").html("您输入的账号有误!");
    						 $("#loginIn").attr("disabled",true);
    					}
      				}
      				},
        ...
        <div class="publish-box z-depth-4">
            <div class="row">
                ...
                <form action="<%=basePath%>user/addUser" method="POST" role="form" id="signup_form">
                    <div class="input-field col s12">
                        <input type="text" name="email" placeholder="请以xxxx@cugb.edu.com的格式输入" id="email" required="required" pattern="^[a-zA-Z0-9_-]+@[cugb]+\.[edu]+\.[cn]+$" class="validate ng-pristine ng-empty ng-invalid ng-invalid-required ng-valid-pattern ng-touched" />
                    ...
                    <a href="<%=basePath%>goods/homeGoods">
                        <div class="bannerimg">
                            <ul class="bannerul">
                                ...
                                <p class="text2">欢迎来到全新的校园二手交易平台</p>
                                <p class="text3">——<span>地大黑店 </span></p>
                                <p class="text4">加入地大黑店，搜罗你想要的东西。</p>
                            </ul>
                          <!--   <div class="logoimg">
                                <img src="../img/logo_yl.jpg" />
                            </div> -->
                        </div>
                    </a>
                </li>
